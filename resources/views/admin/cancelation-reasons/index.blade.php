        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Cancelation Reasons</li>
                ...
                <section class="panel">
                    ...
                    <header class="panel-heading">
                        ...
                        <span class="tools pull-right">
                            ...
                            <a href="{{ url('admin/cancelation-reasons/create') }}" class="btn btn-info btn-sm" title="Add New Reason">
    ...
    $("document").ready(function () {
        ...
        $('#datatable').DataTable({
            ...
            ajax: {
                ...
                url: "{{url('admin/get-cancelation-reasons')}}",                
        ...
        $('#datatable').on('click', '.btn-delete', function (e) { 
            ...
            var url= "{{url('admin/cancelation-reasons')}}"+'/'+id;
