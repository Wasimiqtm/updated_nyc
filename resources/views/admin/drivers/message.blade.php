...
<section id="main-content" >
    ...
    <section class="wrapper">
        ...
        {!! Form::open(['url' => 'admin/send-message-to-drivers', 'data-toggle' => 'validator', 'data-disable' => 'false', 'class' => 'form-horizontal', 'files' => true]) !!}
                ...
                <div class="row">            
                    ...
                    <div class="col-lg-12">
                        ...
                        <section class="panel">
                            ...
                            <header class="panel-heading">Send Message to Drivers</header>
                                ...
                                <div class="position-center">                     
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        {!! Form::label('send_all', 'Select All Drivers', ['class' => 'control-label']) !!}                                    
                                    </div>
                                  </div>  
                                                                                           
                                  <div class="form-group {{ $errors->has('driver_id') ? 'has-error' : ''}}">
                                    {!! Form::label('driver_id', 'Select Drivers', ['class' => 'col-md-3 control-label required-input']) !!}
                                    <div class="col-md-9">
                                        {!! Form::select('driver_id[]', $drivers,null, ['class' => 'form-control select2','required' => 'required','multiple' => 'multiple']) !!}
