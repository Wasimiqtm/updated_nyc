          ...
          <div class="box-footer-top">
            <div class="row align-items-center">
              <div class="col-lg-6 col-md-6 text-md-start text-center mb-15 wow fadeInUp">
                <div class="d-flex align-items-center justify-content-md-start justify-content-center"><a class="mr-30" href="#"><img src="{{asset('assets/imgs/template/logo.svg')}}" alt="Luxride"></a><a class="text-14-medium call-phone color-white hover-up" href="tel:+41227157000">+41 22 715 7000</a></div>
              </div>
...
<!-- Mirrored from creativelayers.net/themes/luxride-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 21:53:17 GMT -->
</html>