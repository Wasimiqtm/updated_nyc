                   ...
                   if(res.status){
                        $.each(res.categories, function(index,category){
                            if(category.total_charges>0){
                                $(".fleet-list").append('<li><span class="fleet-name">'+category.name+'</span><span class="fleet-price">$'+category.total_charges+' <i class="fa fa-info-circle" aria-hidden="true"></i></span></li>');
                            }
                        });
                       }else{
