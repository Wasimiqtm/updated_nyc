...
Route::get('/quotesreservations', 'HomeController@index');
Route::get('/ultra-luxury-sedans', 'HomeController@aboutUs1');
...
Route::get('/faq', 'HomeController@termsConditions');
Route::get('/about-us', 'HomeController@aboutUs');

Route::get('/cheap-limo-black-car-service-nyc', 'HomeController@SampleContent');

Route::get('/about', 'HomeController@aboutUs1');
Route::get('/services', 'HomeController@services');
Route::get('/other-services', 'HomeController@otherservices');
Route::get('/privacy', 'HomeController@services');
Route::get('/fleet', 'HomeController@services');
Route::get('/category/services', 'HomeController@services');
